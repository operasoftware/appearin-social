...
var MESSAGE = chrome.i18n.getMessage("extMessage") + '\n$1';
var LABEL = chrome.i18n.getMessage("extLabel");
var LABEL_o = "Start a video call via appear.in";
...
var hitchhikeOnVidechatButtons = function() {
  ...
  for (var j = 0, flyout; flyout = flyouts[j]; j++) {
    ...
    var buttonNotPresent =
        flyout.querySelectorAll('.appearin-icon').length === 0;
    var correctFlyout =
        flyout.querySelectorAll('.addToThread.button').length === 1;
